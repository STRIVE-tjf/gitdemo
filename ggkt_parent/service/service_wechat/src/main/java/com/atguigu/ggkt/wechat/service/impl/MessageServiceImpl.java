...
public class MessageServiceImpl implements MessageService {
    @Autowired
    private CourseFeignClient courseFeignClient;//远程调用接口
    @Autowired
    private WxMpService wxMpService;
    //微信公众号发送模板消息
    @Override
    public void pushPayMessage(Long id) {
        String openid = "oZkgI6Ckj3a-fT-6uETQo1QZ6lsw";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("4xPuttVxM8XX9NTnC28ueDXRjtgeTvCjyxyRHOKh4c4")//模板id
                .url("http://tianjf.viphk.91tunnel.com/#/pay/"+id)//点击模板消息要访问的网址
                .build();
        //3,如果是正式版发送消息，，这里需要配置你的信息
        templateMessage.addData(new WxMpTemplateData("first", "亲爱的用户：您有一笔订单支付成功111。", "#272727"));
    ...
    private String aboutUs(Map<String, String> param) {
        String str = "硅谷课堂现开设Java、HTML5前端+全栈、大数据、全链路UI/UE设计、人工智能、大数据运维+Python自动化、Android+HTML5混合开发等多门课程；同时，通过视频分享、谷粒学苑在线课堂、大厂学苑直播课堂等多种方式，满足了全国编程爱好者对多样化学习场景的需求，已经为行业输送了大量IT技术人才。";
        String str1 = "感谢你那么帅那么漂亮还来关注本帅";
        StringBuffer text = this.text(param, str1);
    ...
    private String subscribe(Map<String, String> param) {
        StringBuffer text = this.text(param, "感谢你关注“硅谷课堂”，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等");
        return text.toString();
    }
